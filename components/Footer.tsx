    ...
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          Ready to build something <span className="text-purple">amazing</span>{" "}
          together?
        </h1>
        ...
        <div className="flex flex-col gap-4 items-center">
          <a href="mailto:sahil971chawla@gmail.com">
            <MagicButton
          ...
          <a
            ...
            className="px-6 py-3 rounded-full border border-purple text-purple hover:bg-purple hover:text-black transition-colors text-center relative z-10 cursor-pointer"
          >
            Download Resume
          </a>
        </div>
